...
ImguiWindow.restrain_window = function (self)
    ...
    self.window_restrained_direction.x = restrain_direction(self.window_restrained_direction.x, self.window_restrained_mouse_position.x, mouse_position.x)
    self.window_restrained_direction.y = restrain_direction(self.window_restrained_direction.y, self.window_restrained_mouse_position.y, mouse_position.y)
