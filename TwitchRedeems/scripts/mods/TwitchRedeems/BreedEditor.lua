...
BreedEditor.render_ui = function (self)
    ...
    if window_open then
        ...
        if self.redeem_breed and Imgui.button("Clear Breeds") then
            mod.redeem_breeds = {}
            self.gui_dropdown_redeem_breed = create_redeem_breeds_gui_dropdown_list() -- TODO code dedup
            self.gui_dropdown_redeem_breed_index = math.min(self.gui_dropdown_redeem_breed_index, #self.gui_dropdown_redeem_breed)
        end
        ...
        if self.redeem_breed then
            ...
            self.gui_dropdown_redeem_breed_index = Imgui.combo("Redeem Breed", self.gui_dropdown_redeem_breed_index, self.gui_dropdown_redeem_breed, 5)
